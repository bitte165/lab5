package ru.bitte.lab5.route;

import ru.bitte.lab5.exceptions.ElementConstructionException;
...
//        return toString();
    ...
    private int calculateDistance(long x1, long y1, float z1, long x2, long y2, float z2) {
